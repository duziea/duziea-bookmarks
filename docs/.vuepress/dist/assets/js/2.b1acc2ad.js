  ...
  [
          ...
          return n
            ? n.map(e =>
                (function t(e, n, r, i = 1) {
                  ...
                  if (Array.isArray(e))
                    return Object.assign(h(n, e[0], r), { title: e[1] })
                  {
                    i > 3 &&
                      console.error(
    ...
    function(t, e, n) {
      ...
      t.exports = function(t, e, n, d, v, g, m) {
        ...
        var b,
          ...
          O = !1,
          L = t.prototype,
          w = L[f] || L['@@iterator'] || (v && L[v]),
          C = w || _(v),
          $ = v ? (S ? _('entries') : C) : void 0,
          j = ('Array' == e && L.entries) || w
        if (
          (j &&
    ...
    function(t, e, n) {
      ...
      var r = n(17),
        ...
        p = /\$([$&`']|\d\d?|<[^>]*>)/g,
        h = /\$([$&`']|\d\d?)/g
      n(87)('replace', 2, function(t, e, n, d) {
        return [
          function(r, i) {
            var o = t(this),
              a = null == r ? void 0 : r[e]
          ...
          function(t, e) {
            ...
            for (var x, _ = '', k = 0, S = 0; S < b.length; S++) {
              ...
              for (
                var O = String(y[0]),
                  L = c(l(a(y.index), p.length), 0),
                  w = [],
                  C = 1;
                C < y.length;
                C++
              )
                w.push(void 0 === (x = y[C]) ? x : String(x))
              var $ = y.groups
              if (h) {
                var j = [O].concat(w, L, p)
                void 0 !== $ && j.push($)
                var A = String(e.apply(void 0, j))
              } else A = v(O, p, L, w, $, e)
              L >= k && ((_ += p.slice(k, L) + A), (k = L + O.length))
            }
            return _ + p.slice(k)
          }
        ]
    ...
    function(t, e, n) {
      ...
      var r = n(15),
        i = {
          ...
          components: { DropdownTransition: n(108).a },
          beforeCreate: function() {
            this.$options.components.SidebarLinks = n(107).default
          },
    ...
    function(t, e, n) {
      n(150), (t.exports = n(22).Array.isArray)
    },
    function(t, e, n) {
      var r = n(54)
      r(r.S, 'Array', { isArray: n(154) })
    },
    function(t, e) {
      t.exports = function(t) {
        if ('function' != typeof t) throw TypeError(t + ' is not a function!')
    ...
    function(t, e, n) {
      n(93), n(169), (t.exports = n(22).Array.from)
    },
    function(t, e, n) {
      var r = n(58),
        i = n(59)
    ...
    function(t, e, n) {
              ...
              suggestions: function() {
                ...
                if (t) {
                  for (
                    ...
                    var s = e[a]
                    if (this.getPageLocalePath(s) === r && this.isSearchable(s))
                      if (i(s)) o.push(s)
                      else if (s.headers)
                        for (
                          var u = 0;
                          u < s.headers.length && !(o.length >= n);
                          u++
                        ) {
                          var c = s.headers[u]
                          i(c) &&
      ...
      var w = {
          ...
          mounted: function() {
            var t = this,
              e =
                parseInt(L(this.$el, 'paddingLeft')) +
                parseInt(L(this.$el, 'paddingRight')),
              n = function() {
          ...
          computed: {
            ...
            editLink: function() {
              ...
              return t && u && this.$page.relativePath
                ? this.createEditLink(n, u, i, a, this.$page.relativePath)
                : null
            },
      ...
      var D = I,
        ...
        H = {
          name: 'Sidebar',
          components: { SidebarLinks: n(107).default, NavLinks: O },
          props: ['items']
        },
        U =
          (n(201),
